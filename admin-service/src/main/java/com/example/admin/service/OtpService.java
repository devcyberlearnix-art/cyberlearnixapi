...
public class OtpService {
    ...
    private static final String OTP_SESSION_PREFIX = "ADMIN:OTP:SESSION:";
    private static final String OTP_COOLDOWN_PREFIX = "ADMIN:OTP:COOLDOWN:";
    private static final String OTP_LATEST_PREFIX = "ADMIN:OTP:LATEST:";
