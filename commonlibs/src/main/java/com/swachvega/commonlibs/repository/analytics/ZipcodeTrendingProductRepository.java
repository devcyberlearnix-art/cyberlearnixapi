...
import com.cyberlearnix.commonlibs.dto.analytics.ZipcodeTrendingProduct;
...
/**
 * Repository for querying mv_zipcode_trending_products materialized view
 */
@Repository
public interface ZipcodeTrendingProductRepository extends JpaRepository<ZipcodeTrendingProduct, Long> {
    
    /**
     * Get trending products for a zipcode
     */
        @Query(value = "SELECT m.product_id, p.gtin, m.product_name, p.brand_name, p.front_image_url " +
            "FROM mv_zipcode_trending_products m " +
